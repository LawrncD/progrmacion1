...
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.createCustomParser;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.ingresarByte;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.ingresarDato;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.ingresarEntero;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.ingresarFecha;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.ingresarTexto;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.mostrarError;
import static co.edu.uniquindio.poo.util.src.main.java.co.edu.uniquindio.poo.ESUtil.mostrarMensaje;
