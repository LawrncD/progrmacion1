...
public class AppTest {
    ...
    public void datosCompletos() {
        ...
        CuentaBancaria cuentaManuel = new CuentaBancaria("Manuel", "Pineda", "1092455543", TipoCuenta.CORRIENTE);
        bancolombia.agregarCuenta(cuentaManuel);

        System.out.println(
                "La actividad de la cuenta  cuentaManuel antes del deposito: " + cuentaManuel.verificarActividad());
        bancolombia.depositar(cuentaManuel, 100000);
        System.out.println(
                "La actividad de la cuenta cuentaManuel despues del deposito: " + cuentaManuel.verificarActividad());
        ...
        CuentaBancaria cuentaBancaria2 = new CuentaBancaria("Manuel", "pineda", "1092455543", TipoCuenta.AHORROS);
        ...
        CuentaBancaria cuentaBancaria3 = new CuentaBancaria("Manuel", "pineda", "1092455543", TipoCuenta.CORRIENTE);
